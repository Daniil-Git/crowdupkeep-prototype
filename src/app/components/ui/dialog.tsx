...
function DialogContent({
  ...
  // Default aria-describedby to undefined so Radix's
  // DescriptionWarning does not fire for dialogs that intentionally
  // ship no DialogDescription (e.g. the toast-style
